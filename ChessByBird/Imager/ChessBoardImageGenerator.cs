...
namespace ChessByBird.ImagingProject
{
    ...
    public class ChessBoardImageGenerator
    {
        ...
        private string chessBlackPlayerLabel;

        public string BlackPlayerLabel
        {
            get { return chessBlackPlayerLabel; }
            set { chessBlackPlayerLabel = value; }
        }
        
        private string chessWhitePlayerLabel;

        public string WhitePlayerLabel
        {
            get { return chessWhitePlayerLabel; }
            set { chessWhitePlayerLabel = value; }
        }
        ...
        private void SetChessBoardPlayerNames()
        {
            ...
            if (whiteLabel == null) whiteLabel = "Mike White";
            if (blackLabel == null) blackLabel = "Joe Black";
            ...
            {
                whiteLabel = turnPrefix + blackLabel + turnSuffix;
            }
